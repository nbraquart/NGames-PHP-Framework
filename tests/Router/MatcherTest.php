...
class MatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('\Framework\Router\InvalidMatcherException', 'Missing module key or module value, or provided both');
    ...
    {
        $this->setExpectedException('\Framework\Router\InvalidMatcherException', 'Missing controller key or controller value, or provided both');
    ...
    {
        $this->setExpectedException('\Framework\Router\InvalidMatcherException', 'Missing action key or action value, or provided both');
