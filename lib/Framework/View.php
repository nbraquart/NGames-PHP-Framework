...
class View
{
    ...
    /**
     * Extension used for views. Not changeable but could be
     * @var string
     */
    const VIEWS_EXTENSION = '.phtml';
    
    /**
     * Variable name storing placeholders. If overriden by client application, an exception is thrown.
     * @var string
     */
    ...
    public function __construct($script = null)
    {
        ...
        $this->variables = array(self::VARIABLE_PLACEHOLDERS => array());
    }
    ...
    /**
     * This function is used for both set/get placeholder. Switch relies on $value being null or not.
    ...
    /**
     * Starts a placeholder. Always use placeHolderStop() or an exception will be thrown.
     * @param string $name
     */
    ...
    /**
     * Helper function to set layout (actually parent view), from a string. It also changes the script directory.
     * @param string $layout
